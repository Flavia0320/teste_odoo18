...
class DeclaratiaD300(models.Model):
    ...
    pro_rata = fields.Float(string="Pro-rata", default=0)
    ...
    totalPlata_A = fields.Float(compute="_get_totalPlata_A", store=True)

    R1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R2_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R3_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R3_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R4_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R5_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R5_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R5_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R5_1_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R6_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R6_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R7_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R7_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R7_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R7_1_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R8_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R8_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R9_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R9_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R10_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R10_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R11_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R11_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_1_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_2_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_2_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_3_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R12_3_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R13_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R14_1 = fields.Float(compute="_get_totalPlata_A", store=True)

    #TODO
    R67_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R68_1 = fields.Float(compute="_get_totalPlata_A", store=True)

    R15_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R16_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R16_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R64_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R64_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R65_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R65_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R17_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R17_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R18_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R18_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R18_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R18_1_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R19_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R19_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R20_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R20_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R20_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R20_1_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R21_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R21_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R22_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R22_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R23_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R23_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R24_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R24_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_1_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_2_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_2_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_3_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R25_3_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R43_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R44_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R26_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R26_1_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R27_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R27_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R28_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R29_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R30_1 = fields.Float(compute="_get_totalPlata_A", store=True)
    R30_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R31_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R32_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R33_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R34_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R35_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R36_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R37_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R38_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R39_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R40_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R41_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    R42_2 = fields.Float(compute="_get_totalPlata_A", store=True)
    ...
    def get_balance(self, tag):
        ...
        if move_lines:
            return round(abs(sum(move_lines.mapped('balance'))), 2)
        return 0
        ...
        for s in self:
            ...
            for record in self:
                ...
                if acc_4423 and acc_4424:
                    ...
                    R35_2_old = round(sum(ml_lines_4423.mapped("balance")), 2)
                    ...
                    R38_2_old = round(sum(ml_lines_4424.mapped("balance")), 2)
    ...
    baza = fields.Float("Baza", compute="get_invoice_data", store=True)
    tva = fields.Float("TVA", compute="get_invoice_data", store=True)
    nr_facturi_primite = fields.Integer("Nr Facturi Primite", compute="get_invoice_data", store=True)
    baza_primite = fields.Float("Baza Primite", compute="get_invoice_data", store=True)
    tva_primite = fields.Float("TVA Primite", compute="get_invoice_data", store=True)
    valoare_a = fields.Float(compute="get_invoice_data", store=True)
    valoare_a1 = fields.Float(compute="get_invoice_data", store=True)
    tva_a = fields.Float(compute="get_invoice_data", store=True)
    tva_a1 = fields.Float(compute="get_invoice_data", store=True)
    valoare_b = fields.Float(compute="get_invoice_data", store=True)
    valoare_b1 = fields.Float(compute="get_invoice_data", store=True)
    tva_b = fields.Float(compute="get_invoice_data", store=True)
    tva_b1 = fields.Float(compute="get_invoice_data", store=True)
    nr_fact_emise = fields.Integer(compute="get_invoice_data", store=True)
    total_baza = fields.Float(compute="get_invoice_data", store=True)
    total_tva = fields.Float(compute="get_invoice_data", store=True)
    total_precedent = fields.Float(compute="get_invoice_data", store=True)
    total_curent = fields.Float(compute="get_invoice_data", store=True)
    ...
    def get_invoice_data(self):
        for s in self:
            ...
            s.baza = round(sum(facturi.mapped('amount_untaxed_signed')), 2)
            s.tva = round(sum(facturi.mapped('amount_tax_signed')), 2)
            ...
            s.baza_primite = round(sum(facturi_primite.mapped('amount_untaxed_signed')), 2)
            s.tva_primite = round(sum(facturi_primite.mapped('amount_tax_signed')), 2)
